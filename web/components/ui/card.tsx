  ...
  return (
    ...
    <nav className="group w-50 h-60 [perspective:1000px]">
      ...
      <div className="relative w-full h-full transition-all duration-500 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]">
        ...
        <div className="absolute w-full h-full p-4 space-y-8 [backface-visibility:hidden] bg-white/10 backdrop-blur-md border border-white/20 rounded-lg flex flex-col items-center justify-center">
            {media}

            <div className="space-y-4 w-full flex flex-col items-center">
                <div className="w-full border-t border-white "></div>
                <p className="text-white font-medium text-2xl">{tittle}</p>
            </div>
        ...
        <div className="absolute p-4 space-y-2 w-full h-full [backface-visibility:hidden] bg-amber-500 rounded-lg flex flex-col items-center justify-start [transform:rotateY(180deg)]">
            <p className="text-black font-bold text-2xl">{tittle}</p>
            <p className="text-black text-justify text-sm">{description}</p>
